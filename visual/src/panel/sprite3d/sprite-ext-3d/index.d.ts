...
declare namespace ext3d {
  ...
  export class Mesh3d extends Group3d {
     ...
     * @param options 
     */
    constructor (program: Program, attrs?: Attrs3d)
  ...
  type Attrs3d = Omit<Attrs, 'pos'> & { pos: [ number, number, number ] }

  class Node3dWeek extends Node {
    attributes: any
  }

  export class Node3d extends Node3dWeek {
    /**
