import * as spritejs from  'spritejs'//'https://unpkg.com/spritejs/dist/spritejs.esm.js';
var ext3d =
...
/* harmony import */ var spritejs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49);
...
/* harmony import */ var _node_path3d__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(77);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Path3d", function() { return _node_path3d__WEBPACK_IMPORTED_MODULE_13__["default"]; });

/* harmony import */ var _node_group3d__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(55);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Group3d", function() { return _node_group3d__WEBPACK_IMPORTED_MODULE_14__["default"]; });

/* harmony import */ var _node_render_target__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(79);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RenderTarget", function() { return _node_render_target__WEBPACK_IMPORTED_MODULE_15__["default"]; });

/* harmony import */ var _helper_shadow__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(53);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Shadow", function() { return _helper_shadow__WEBPACK_IMPORTED_MODULE_16__["default"]; });

/* harmony import */ var _helper_texture_loader__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(80);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TextureLoader", function() { return _helper_texture_loader__WEBPACK_IMPORTED_MODULE_17__["default"]; });

/* harmony import */ var _helper_geometry__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(60);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Geometry", function() { return _helper_geometry__WEBPACK_IMPORTED_MODULE_18__["default"]; });

/* harmony import */ var _helper_light__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(51);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Light", function() { return _helper_light__WEBPACK_IMPORTED_MODULE_19__["default"]; });

/* harmony import */ var _shader__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(81);
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "shaders", function() { return _shader__WEBPACK_IMPORTED_MODULE_20__; });
...
/* harmony import */ var _extras_Torus_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(31);
...
/* harmony import */ var _extras_Orbit_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(32);
...
/* harmony import */ var _extras_Raycast_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(33);
...
/* harmony import */ var _extras_Curve_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(34);
...
/* harmony import */ var _extras_Post_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(35);
...
/* harmony import */ var _extras_Skin_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(36);
...
/* harmony import */ var _extras_Animation_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(37);
...
/* harmony import */ var _extras_Text_js__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(38);
...
/* harmony import */ var _extras_NormalProgram_js__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(39);
...
/* harmony import */ var _extras_Flowmap_js__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(40);
...
/* harmony import */ var _extras_GPGPU_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(41);
...
/* harmony import */ var _extras_Polyline_js__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(42);
...
/* harmony import */ var _extras_Shadow_js__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(43);
...
/* harmony import */ var _extras_KTXTexture_js__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(44);
...
/* harmony import */ var _extras_TextureLoader_js__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(45);
...
/* harmony import */ var _Animation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(37);
...
/* harmony import */ var _core_Texture_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19);
/* harmony import */ var _KTXTexture_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44);
...
class Group3d extends _node3d__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(attrs = {}) {
    super(attrs);
    this.setBody(new ogl__WEBPACK_IMPORTED_MODULE_1__["Transform"]());
    this[_children] = [];
    this[_zOrder] = 0;
  }
  /* override */
    ...
    if (typeof Proxy === 'function') {
      ...
      if (program) {
        return new Proxy(program.uniforms, {
          ...
          set(obj, prop, value) {
            if (prop in obj) {
              obj[prop].value = Object(_helper_parse_color__WEBPACK_IMPORTED_MODULE_5__["parseColor"])(value);
            } else {
              obj[prop] = {
                value: Object(_helper_parse_color__WEBPACK_IMPORTED_MODULE_5__["parseColor"])(value)
              };
            }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorAttribute", function() { return colorAttribute; });
...
class Torus extends _mesh3d__WEBPACK_IMPORTED_MODULE_3__["default"] {
  /* override */
  onPropertyChange(key, newValue, oldValue) {
    super.onPropertyChange(key, newValue, oldValue);
  ...
  remesh() {
    ...
    const geometry = new ogl__WEBPACK_IMPORTED_MODULE_1__["Torus"](gl, {
      radius,
      tube,
      radialSegments,
      tubularSegments,
...
_defineProperty(Torus, "Attr", _attribute_torus__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
const getAttribute = Symbol.for('spritejs_getAttribute');
const setDefault = Symbol.for('spritejs_setAttributeDefault');
class TorusAttr extends _mesh3d__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(subject) {
    super(subject);
    this[setDefault]({
      radius: 0.5,
...
function setData({
  ...
  for (let i = 0; i < len - 1; i++) {
    ...
    const p1 = new ogl__WEBPACK_IMPORTED_MODULE_1__["Vec3"](point[0], point[1], -0.5 * depth);
    const p2 = new ogl__WEBPACK_IMPORTED_MODULE_1__["Vec3"](point[0], point[1], 0.5 * depth);
    const p3 = new ogl__WEBPACK_IMPORTED_MODULE_1__["Vec3"](next[0], next[1], -0.5 * depth);
    const p4 = new ogl__WEBPACK_IMPORTED_MODULE_1__["Vec3"](next[0], next[1], 0.5 * depth);
    ...
    const a = new ogl__WEBPACK_IMPORTED_MODULE_1__["Vec3"]().sub(p1, p3).scale(dir || 1);
    const n = [0, 0, depth];
    const norm = new ogl__WEBPACK_IMPORTED_MODULE_1__["Vec3"]().cross(a, n).normalize();
...
class Path3d extends _mesh3d__WEBPACK_IMPORTED_MODULE_3__["default"] {
  /* override */
  onPropertyChange(key, newValue, oldValue) {
    super.onPropertyChange(key, newValue, oldValue);
  ...
  remesh() {
    ...
    if (mesh) {
      ...
      const geometry = new _helper_geometry__WEBPACK_IMPORTED_MODULE_4__["default"](gl, {
        position,
        index,
        normal,
        uv
...
_defineProperty(Path3d, "Attr", _attribute_path3d__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TEXTURE_NORMAL_MAP_WITH_BUMP_100", function() { return TEXTURE_NORMAL_MAP_WITH_BUMP_100; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TEXTURE_NORMAL_MAP_WITH_BUMP_300", function() { return TEXTURE_NORMAL_MAP_WITH_BUMP_300; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GEOMETRY_NORMAL_MAP_WITH_BUMP_100", function() { return GEOMETRY_NORMAL_MAP_WITH_BUMP_100; });
...
const BASE_GEOMETRY = {
  vertex: _base_geometry_vert__WEBPACK_IMPORTED_MODULE_3__["default"],
  fragment: _base_geometry_frag__WEBPACK_IMPORTED_MODULE_2__["default"]
};
const GEOMETRY = {
  vertex: _geometry_vert__WEBPACK_IMPORTED_MODULE_5__["default"],
  fragment: _geometry_frag__WEBPACK_IMPORTED_MODULE_4__["default"]
};
const NORMAL_GEOMETRY = GEOMETRY;
const TEXTURE = {
  vertex: _texture_vert__WEBPACK_IMPORTED_MODULE_7__["default"],
  fragment: _texture_frag__WEBPACK_IMPORTED_MODULE_6__["default"]
};
const NORMAL_TEXTURE = TEXTURE;
const GEOMETRY_WITH_TEXTURE = TEXTURE;
const TEXTURE_CUBE = {
  vertex: _texture_cube_vert__WEBPACK_IMPORTED_MODULE_9__["default"],
  fragment: _texture_cube_frag__WEBPACK_IMPORTED_MODULE_8__["default"]
};
const TEXTURE_WITH_SHADOW = {
  vertex: _texture_with_shadow_vert__WEBPACK_IMPORTED_MODULE_11__["default"],
  fragment: _texture_with_shadow_frag__WEBPACK_IMPORTED_MODULE_10__["default"]
};
...
const POLYLINE = {
  vertex: _polyline_vert__WEBPACK_IMPORTED_MODULE_15__["default"],
  fragment: _polyline_frag__WEBPACK_IMPORTED_MODULE_14__["default"]
};
const DASHLINE = {
  vertex: _dashline_vert__WEBPACK_IMPORTED_MODULE_17__["default"],
  fragment: _dashline_frag__WEBPACK_IMPORTED_MODULE_16__["default"]
};
const TEXTURE_NORMAL_MAP_100 = {
  vertex: _texture_normal_map_100_vert__WEBPACK_IMPORTED_MODULE_19__["default"],
  fragment: _texture_normal_map_100_frag__WEBPACK_IMPORTED_MODULE_18__["default"]
};
const TEXTURE_NORMAL_MAP_WITH_BUMP_100 = {
  vertex: _texture_normal_map_100_vert__WEBPACK_IMPORTED_MODULE_19__["default"],
  fragment: _texture_normal_map_100_frag__WEBPACK_IMPORTED_MODULE_18__["default"].replace(/(#ifdef FLAG_BUMP)/, '#define FLAG_BUMP\n$1')
};
const TEXTURE_NORMAL_MAP_300 = {
  vertex: _texture_normal_map_300_vert__WEBPACK_IMPORTED_MODULE_21__["default"],
  fragment: _texture_normal_map_300_frag__WEBPACK_IMPORTED_MODULE_20__["default"]
};
const TEXTURE_NORMAL_MAP_WITH_BUMP_300 = {
  vertex: _texture_normal_map_300_vert__WEBPACK_IMPORTED_MODULE_21__["default"],
  fragment: _texture_normal_map_300_frag__WEBPACK_IMPORTED_MODULE_20__["default"].replace(/(#ifdef FLAG_BUMP)/, '#define FLAG_BUMP\n$1')
};
function getTextureNormalMap(layer, bump = false) {
...
const GEOMETRY_NORMAL_MAP_100 = {
  vertex: _geometry_normal_map_100_vert__WEBPACK_IMPORTED_MODULE_23__["default"],
  fragment: _geometry_normal_map_100_frag__WEBPACK_IMPORTED_MODULE_22__["default"]
};
const GEOMETRY_NORMAL_MAP_WITH_BUMP_100 = {
  vertex: _geometry_normal_map_100_vert__WEBPACK_IMPORTED_MODULE_23__["default"],
  fragment: _geometry_normal_map_100_frag__WEBPACK_IMPORTED_MODULE_22__["default"].replace(/(#ifdef FLAG_BUMP)/, '#define FLAG_BUMP\n$1')
};
const GEOMETRY_NORMAL_MAP_300 = {
  vertex: _geometry_normal_map_300_vert__WEBPACK_IMPORTED_MODULE_25__["default"],
  fragment: _geometry_normal_map_300_frag__WEBPACK_IMPORTED_MODULE_24__["default"]
};
const GEOMETRY_NORMAL_MAP_WITH_BUMP_300 = {
  vertex: _geometry_normal_map_300_vert__WEBPACK_IMPORTED_MODULE_25__["default"],
  fragment: _geometry_normal_map_300_frag__WEBPACK_IMPORTED_MODULE_24__["default"].replace(/(#ifdef FLAG_BUMP)/, '#define FLAG_BUMP\n$1')
};
function getGeometryNormalMap(layer, bump = false) {
  const isWebgl2 = layer.renderer.isWebgl2;
...
const _ext3d$Torus = ext3d['Torus'];
...
const _ext3d$Path3d = ext3d['Path3d'];
